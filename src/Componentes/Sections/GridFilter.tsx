...
interface Card {
  ...
  slug: string;
  title: string;
  category: '8 días - 10 días' | '11 días - 13 días' | '14 días - 15 días' | '16 días - 18 días';
...
const categories = ['8 días - 10 días', '11 días - 13 días', '14 días - 15 días', '16 días - 18 días'] as const;
